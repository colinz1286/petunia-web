      ...
      <div className="w-full max-w-2xl mx-auto px-2 sm:px-4">
        ...
        <div className="mb-6">
          ...
          <div
            ...
            className="inline-flex rounded-md shadow-sm overflow-hidden border"
          >
            {([
              { key: 'all', label: typeLabels.all },
              { key: 'boardingDaycare', label: typeLabels.boardingDaycare },
              { key: 'breeder', label: typeLabels.breeder },
            ] as { key: BusinessTypeFilter; label: string }[]).map(({ key, label }, idx, arr) => {
              ...
              >
                ...
                <div className="flex justify-end mt-4">
                  <button
                    ...
                    className="px-4 py-2 rounded-md bg-[color:var(--color-accent)] text-white hover:opacity-90 transition text-sm"
                  >
