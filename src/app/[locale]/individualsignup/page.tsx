    ...
    <main className="min-h-screen bg-[#f6efe4] text-[#2c4a30] font-sans flex flex-col items-center px-4 py-10">
      <div className="w-full max-w-md space-y-6 px-2 sm:px-4">
        ...
        <div className="space-y-4">
          ...
          <input type="text" placeholder="Zip Code" value={form.zipCode} onChange={e => handleChange('zipCode', e.target.value.slice(0, 5))} className="w-full px-4 py-2 border-2 border-gray-300 rounded text-sm outline-none bg-white" />
        </div>
