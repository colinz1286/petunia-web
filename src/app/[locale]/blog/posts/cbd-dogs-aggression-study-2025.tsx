  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A detailed review of new research showing that long-term CBD supplementation may reduce aggression in older dogs. Learn what the data actually says, its limitations, and what dog owners should know before trying CBD."
        />
      </Head>
