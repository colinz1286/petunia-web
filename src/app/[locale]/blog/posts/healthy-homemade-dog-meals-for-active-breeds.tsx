  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Active dogs burn calories fast—and need more than basic kibble can provide. Learn how to make balanced homemade meals for working and athletic breeds, with calorie charts, vet-approved recipes, and key nutrient tips from AAFCO guidelines."
        />
