    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Compare national manager pay averages from Indeed and ZipRecruiter, plus real-world benefits and ownership insights from a Pittsburgh-area facility."
                />
            </Head>
