...
export default function BostonTerrierBreedGuide2025() {
  ...
  const description =
    'Everything you need to know about the Boston Terrier in 2025 — temperament, exercise needs, health risks, training expectations, ideal home environments, and long-term care essentials.';
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://www.petuniapets.com/${locale}/blog/boston-terrier-breed-guide-2025`}
        />
      </Head>
