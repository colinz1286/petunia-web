...
export default function BoardingAndDaycareTipsForFrenchBulldogs() {
  ...
  const description =
    'A practical, evidence-informed playbook for boarding and daycare with French Bulldogs: pre-boarding audits, health & vaccine requirements, airway and heat safety (BOAS), crate/room setup, playgroup design, feeding & meds, staff communication, travel, and emergency protocols—plus downloadable checklists and professional veterinary sources.';
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://www.petuniapets.com/${locale}/blog/boarding-and-daycare-tips-for-french-bulldogs`}
        />
