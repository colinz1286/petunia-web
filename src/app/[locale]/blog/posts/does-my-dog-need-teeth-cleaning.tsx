  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A practical, evidence-aligned guide to dog dental care: when cleanings are needed, how a professional COHAT works, typical costs, what pet insurance covers, the best at-home tools and VOHC-accepted chews, and risk-balanced anesthesia decisions for senior dogs."
        />
