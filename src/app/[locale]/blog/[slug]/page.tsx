...
export default function BlogPostPage() {
    ...
    useEffect(() => {
        document.title = `${title} – Petunia Blog`;
    }, []);
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Explore the pros and cons of wearing Crocs at dog daycare facilities. See safety considerations, real-world experience, and best practices."
                />
            </Head>
