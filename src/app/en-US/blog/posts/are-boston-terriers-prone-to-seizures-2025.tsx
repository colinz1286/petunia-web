...
export default function AreBostonTerriersProneToSeizures2025() {
  ...
  const description =
    'A complete 2025 guide on seizure risk in Boston Terriers, covering idiopathic epilepsy, genetics, toxins, seizure symptoms, emergency steps, veterinary diagnostics, and long-term treatment options.';
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://www.petuniapets.com/${locale}/blog/are-boston-terriers-prone-to-seizures-2025`}
        />
      </Head>
