...
export default function BostonTerrierPottyTraining2025() {
  ...
  const description =
    'A 2025 guide to Boston Terrier potty training: why the breed is slow to train, ideal schedules by age, crate intervals, reinforcement methods, accident management, regressions, and indoor/outdoor potty setups.';
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://www.petuniapets.com/${locale}/blog/boston-terrier-potty-training-2025`}
        />
      </Head>
