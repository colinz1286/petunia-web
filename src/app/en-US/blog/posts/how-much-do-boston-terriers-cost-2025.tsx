...
export default function HowMuchDoBostonTerriersCost2025() {
  ...
  const description =
    'A full 2025 guide to Boston Terrier costs including breeder prices, rescue fees, yearly medical expenses, grooming, food, training, insurance, senior care, and hidden lifetime costs.';
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://www.petuniapets.com/${locale}/blog/how-much-do-boston-terriers-cost-2025`}
        />
      </Head>
