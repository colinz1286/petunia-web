  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Is a healthy dog&#39;s nose supposed to be wet or dry? Learn what nose moisture actually means, when dryness and cracking signal a problem, how climate and breed affect the nasal planum, which dog-safe products to use, and the exact red flags that warrant a vet visit."
        />
