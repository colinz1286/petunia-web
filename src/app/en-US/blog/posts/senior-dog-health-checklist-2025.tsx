  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn how to recognize signs of aging in senior dogs—from mobility and cognition to appetite and sleep changes. Includes preventive testing intervals, home adaptations, and nutritional tips for longevity."
        />
