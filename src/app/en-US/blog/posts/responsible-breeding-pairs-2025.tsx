  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn how responsible dog breeders use health screenings, genetic testing, and diversity metrics like the coefficient of inbreeding to produce healthier litters and preserve breed integrity."
        />
