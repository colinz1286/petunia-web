  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A clear, well-written waiver is every boarding or daycare business’s first line of defense. Learn what sections every pet care waiver should include, why they matter legally, and how to store signed forms securely in your system."
        />
