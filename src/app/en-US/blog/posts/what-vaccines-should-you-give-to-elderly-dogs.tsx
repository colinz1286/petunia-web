  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A practical, evidence-aligned guide to vaccinating senior dogs: what stays the same from puppyhood through middle age, what changes in older dogs due to immunosenescence, which vaccines matter most by region and lifestyle, how to minimize side effects in small-breed and high-risk seniors, and how younger housemates affect decisions."
        />
