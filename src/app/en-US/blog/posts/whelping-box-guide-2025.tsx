  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A step-by-step whelping box setup guide for dog breeders. Learn correct dimensions by breed size, safe bedding practices, and how to maintain proper temperature and humidity for newborn pups."
        />
