...
export default function BostonTerrierSeparationAnxiety2025() {
  ...
  const description =
    'A complete 2025 guide to Boston Terrier separation anxiety: root causes, warning signs, desensitization training, crate management, enrichment strategies, and when to speak with a vet or behaviorist.';
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://www.petuniapets.com/${locale}/blog/boston-terrier-separation-anxiety-2025`}
        />
      </Head>
