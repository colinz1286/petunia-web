...
// .local-only/ios-real-reference/BoardingAndDaycareFinancialManagementDashboardView.swift.
// Keep labels, available modules, and navigation targets aligned across both files.
