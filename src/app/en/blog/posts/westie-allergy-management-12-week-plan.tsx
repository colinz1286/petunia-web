...
export default function ArticlePage() {
  ...
  const title = 'Westie Allergy Management Plan: 12-Week Protocol for Itch, Ears, and Skin Flare Reduction';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Westie Allergy Management Plan 12-Week Protocol for Itch, Ears, and Skin Flare Reduction</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/allergy-ear-skin-hotspots" className="underline hover:opacity-80">Ear Infections, Hot Spots, and Skin Irritation: The Allergy Connection</a></li>
