...
export default function ArticlePage() {
  ...
  const title = 'CDC Dog Re-Entry Checklist (2026): Step-by-Step for U.S. Owners Returning from Abroad';
  const date = 'January 4, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>CDC Dog Re-Entry Checklist Step-by-Step for U.S. Owners Returning from Abroad</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/cfia-dog-import-checklist-2026-us-owners" className="underline hover:opacity-80">CFIA Dog Import Checklist (2026): What U.S. Owners Need Before Entering Canada</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/dog-import-canada-2026-checklist-us-owners" className="underline hover:opacity-80">Dog Import to Canada in 2026: Checklist for U.S. Owners (Airline, CFIA, Border, and Return-to-U.S. Rules)</a></li>
          </ul>
        </section>
