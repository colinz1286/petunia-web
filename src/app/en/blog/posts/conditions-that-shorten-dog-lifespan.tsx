      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/boarding-and-daycare-tips-for-french-bulldogs" className="underline hover:opacity-80">Boarding &amp; Daycare Tips for French Bulldogs: A Complete Owner’s Guide</a></li>
          </ul>
        </section>
