...
export default function ArticlePage() {
  ...
  const title = 'Pet Boarding Emergency Plan Template: Heat, Injury, Outbreak, and Evacuation SOPs';
  const date = 'February 2, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Pet Boarding Emergency Plan Template Heat, Injury, Outbreak, and Evacuation SOPs</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/comprehensive-pet-client-profiles-boarding-daycare-software" className="underline hover:opacity-80">Comprehensive Pet &amp; Client Profiles in Dog Boarding Software and Dog Daycare Software</a></li>
