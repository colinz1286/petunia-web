      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/dog-mobility-and-joint-preservation" className="underline hover:opacity-80">Mobility and Joint Preservation: How to Prevent Arthritis, Muscle Loss, and Balance Decline in Ageing Dogs</a></li>
          </ul>
        </section>
