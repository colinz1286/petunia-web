    ...
    <>
      ...
      <article className="prose lg:prose-xl mx-auto px-4 py-8">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/pet-care-waivers-why-they-matter-and-what-to-include" className="underline hover:opacity-80">Pet Care Waivers: Why They Matter and What to Include</a></li>
