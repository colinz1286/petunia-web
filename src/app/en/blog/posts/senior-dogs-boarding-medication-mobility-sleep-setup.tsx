...
export default function ArticlePage() {
  ...
  const title = 'Senior Dogs and Boarding: Medication, Mobility, and Sleep Setup That Reduce Setbacks';
  const date = 'February 12, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Senior Dogs and Boarding Medication, Mobility, and Sleep Setup That Reduce Setbacks</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/medication-administration-tracking-dog-boarding-daycare-software" className="underline hover:opacity-80">Medication Administration Tracking in Dog Boarding Software &amp; Dog Daycare Software: Safety, Workflow Design, Compliance, and Real-World ROI</a></li>
