...
// SEO weakness notes: overlapping topic coverage with nearby site pages; likely limited backlinks; time-bound topic can look temporary
    ...
    return (
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/dog-longevity-drugs-loyal-fda-milestone" className="underline hover:opacity-80">Dog Longevity Drugs Are Getting Real: What Loyal’s FDA Milestones Mean for Owners</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/loyal-loy-002-explained" className="underline hover:opacity-80">LOY-002 Explained: What It Is, Who It Is For, What the FDA Milestone Actually Means, What Trials Measure, and What Is Still Unknown</a></li>
          </ul>
        </section>
