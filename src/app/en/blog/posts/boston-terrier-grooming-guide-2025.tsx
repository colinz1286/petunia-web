...
export default function BostonTerrierGroomingGuide2025() {
  ...
  const description =
    'A full 2025 Boston Terrier grooming guide covering brushing routines, bathing schedule, facial fold care, ear cleaning, nail trimming, shedding, and skin red flags.';
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://www.petuniapets.com/${locale}/blog/boston-terrier-grooming-guide-2025`}
        />
      </Head>
