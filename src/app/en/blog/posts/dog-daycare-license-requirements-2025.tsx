      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/pa-dog-boarding-daycare-license-requirements-2025" className="underline hover:opacity-80">Pennsylvania Dog Boarding &amp; Daycare License Requirements (2025 Guide)</a></li>
