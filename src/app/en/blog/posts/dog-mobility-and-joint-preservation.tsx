      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/stress-colitis-in-dogs" className="underline hover:opacity-80">Stress-Induced Colitis in Dogs: Mucus, Blood, Diarrhea, and How to Prevent Flare-Ups</a></li>
