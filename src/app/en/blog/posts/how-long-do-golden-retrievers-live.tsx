      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/golden-retriever-life-expectancy" className="underline hover:opacity-80">What Is the Life Expectancy of Golden Retrievers? An Evidence-Based Owner’s Guide</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/labrador-lifespan-data-healthspan-guide-2026" className="underline hover:opacity-80">Average Lifespan of Labrador Retrievers: What the Data Really Shows and How Owners Extend Healthspan</a></li>
          </ul>
        </section>
