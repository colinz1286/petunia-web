...
export default function ArticlePage() {
  ...
  const title = 'Traveling with Dogs on Chronic Meds: Vet Letter Template, Dosing Plan, and Border-Friendly Documentation';
  const date = 'February 22, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Traveling with Dogs on Chronic Meds Vet Letter Template, Dosing Plan, and Border-Friendly Documentation</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/pet-boarding-emergency-plan-template-sops" className="underline hover:opacity-80">Pet Boarding Emergency Plan Template: Heat, Injury, Outbreak, and Evacuation SOPs</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/veterinarian-perspectives-on-raw-feeding" className="underline hover:opacity-80">Veterinary Perspectives on Raw Diets: What Your Vet May Not Tell You</a></li>
          </ul>
        </section>
