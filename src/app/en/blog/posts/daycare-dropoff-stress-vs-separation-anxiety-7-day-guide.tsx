...
export default function ArticlePage() {
  ...
  const title = 'Daycare Drop-Off Stress vs Separation Anxiety: How to Tell the Difference in 7 Days';
  const date = 'January 31, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Daycare Drop-Off Stress vs Separation Anxiety How to Tell the Difference in 7 Days</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/food-vs-environmental-allergies-in-dogs-how-to-tell-the-difference" className="underline hover:opacity-80">Food vs. Environmental Allergies in Dogs: How to Tell the Difference</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/separation-anxiety-dogs" className="underline hover:opacity-80">Signs of Separation Anxiety in Dogs (and How to Help Them Cope)</a></li>
          </ul>
        </section>
