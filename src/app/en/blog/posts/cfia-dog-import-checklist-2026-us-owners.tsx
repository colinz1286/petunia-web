...
export default function ArticlePage() {
  ...
  const title = 'CFIA Dog Import Checklist (2026): What U.S. Owners Need Before Entering Canada';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>CFIA Dog Import Checklist What U.S. Owners Need Before Entering Canada</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/cdc-dog-reentry-checklist-2026-us-owners" className="underline hover:opacity-80">CDC Dog Re-Entry Checklist (2026): Step-by-Step for U.S. Owners Returning from Abroad</a></li>
          </ul>
        </section>
