      ...
      <article className="prose lg:prose-xl mx-auto px-4 py-8">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/does-my-dog-need-teeth-cleaning" className="underline hover:opacity-80">Does My Dog Need Teeth Cleaning? A Complete Owner’s Guide to Dental Health, Costs, Insurance, Chews, and Senior Anesthesia Decisions</a></li>
