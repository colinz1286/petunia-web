  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A practical, evidence-aligned guide to the 7 major tick-borne illnesses that affect dogs: Lyme disease, Ehrlichiosis, Anaplasmosis, Babesiosis, Rocky Mountain spotted fever, Bartonellosis, and Hepatozoonosis. Learn the tick species that transmit each disease, where they are most common, hallmark signs, typical veterinary treatments, and which dogs face higher risk—plus prevention and action checklists you can actually use."
        />
