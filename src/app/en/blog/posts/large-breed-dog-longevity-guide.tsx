      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/how-to-train-my-dog-to-sit" className="underline hover:opacity-80">How to Train My Dog to Sit: Gentle Methods, Age Readiness, Household Consistency, Breed Tips, Training Aids, and Troubleshooting</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/why-do-dogs-wag-their-tails" className="underline hover:opacity-80">Why Do Dogs Wag Their Tails? What Wags Really Mean (and Don’t), How to Read Context, and Practical Safety/Training Tips for Every Age</a></li>
          </ul>
        </section>
