...
export default function ArticlePage() {
  ...
  const title = 'Dog Travel Paperwork Folder: The Exact Documents to Carry for Flights, Borders, and Emergency Vet Visits';
  const date = 'December 24, 2025';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Dog Travel Paperwork Folder The Exact Documents to Carry for Flights, Borders, and Emergency Vet Visits</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/senior-dog-health-checklist-2025" className="underline hover:opacity-80">Senior Dog Health Checklist: Signs of Aging and When to See the Vet</a></li>
