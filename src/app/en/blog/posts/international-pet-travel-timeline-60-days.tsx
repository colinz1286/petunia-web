...
export default function ArticlePage() {
  ...
  const title = 'International Pet Travel Timeline (60 Days): Vet Appointments, Forms, and Checkpoints by Week';
  const date = 'February 19, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>International Pet Travel Timeline Vet Appointments, Forms, and Checkpoints by Week</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/how-long-are-dogs-pregnant" className="underline hover:opacity-80">How Long Are Dogs Pregnant? Gestation Timeline, Week-by-Week Development, Signs, Red Flags, Whelping, and Postpartum Care (With Vet-Backed Sources)</a></li>
