    ...
    <>
      ...
      <article className="prose lg:prose-xl mx-auto px-4 py-8">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/french-bulldog-grooming-routine" className="underline hover:opacity-80">French Bulldog Grooming Routine: How Often to Bathe, Brush, and Clean Folds</a></li>
