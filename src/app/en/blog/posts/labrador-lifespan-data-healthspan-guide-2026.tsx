...
export default function ArticlePage() {
  ...
  const title = 'Average Lifespan of Labrador Retrievers: What the Data Really Shows and How Owners Extend Healthspan';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Average Lifespan of Labrador Retrievers What the Data Really Shows and How Owners Extend Healthspan</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/types-of-labrador-retrievers-english-vs-field" className="underline hover:opacity-80">Types of Labrador Retrievers (English vs Field): The Complete, Vet-Informed Owner’s Guide</a></li>
          </ul>
        </section>
