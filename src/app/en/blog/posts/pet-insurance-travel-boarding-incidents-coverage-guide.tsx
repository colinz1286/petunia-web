...
export default function ArticlePage() {
  ...
  const title = 'Pet Insurance for Travel and Boarding Incidents: What Is Covered, Denied, and Misunderstood';
  const date = 'January 6, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Pet Insurance for Travel and Boarding Incidents What Is Covered, Denied, and Misunderstood</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/pet-insurance-dog-daycare-2025" className="underline hover:opacity-80">Pet Insurance and Dog Daycare: What’s Covered, What’s Not</a></li>
