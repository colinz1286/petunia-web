...
export default function ArticlePage() {
  ...
  const title = 'Dog Boarding Vaccination Rules by Facility Type: Core, Optional, and High-Risk Scenario Policies';
  const date = 'January 13, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Dog Boarding Vaccination Rules by Facility Type Core, Optional, and High-Risk Scenario Policies</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/do-kennels-accept-titer-tests" className="underline hover:opacity-80">Do Kennels Accept Titer Tests? State Rules, Facility Policies &amp; What to Ask</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/dog-daycare-boarding-requirements-2025" className="underline hover:opacity-80">Dog Daycare &amp; Boarding Requirements: Complete 2025 U.S. Guide (Vaccines, Ratios, Records, Facility Rules)</a></li>
