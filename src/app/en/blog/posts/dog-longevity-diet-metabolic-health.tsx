      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/dog-ageing-science-cellular-pathways" className="underline hover:opacity-80">How Dog Ageing Actually Works: Cellular Pathways, Inflammation, and Metabolic Decline Explained</a></li>
          </ul>
        </section>
