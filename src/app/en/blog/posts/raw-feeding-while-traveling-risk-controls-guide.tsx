...
export default function ArticlePage() {
  ...
  const title = 'Raw Feeding While Traveling: Safe Handling, Boarding Communication, and Risk Controls';
  const date = 'February 13, 2026';
  const categories = ["owner","boarding","vet","food"] as const;
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Raw Feeding While Traveling Safe Handling, Boarding Communication, and Risk Controls</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
