    ...
    <>
      ...
      <article className="prose lg:prose-xl mx-auto px-4 py-8">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-3">What a strong Border Collie monitoring plan looks like</h2>
          <p className="mb-4">Owners make better decisions when they stop waiting for obvious crises and start tracking baseline health. For Border Collie, that usually means knowing normal appetite, stool quality, weight trend, exercise recovery, breathing effort, sleep quality, coat condition, and behavior at home. Once you know the baseline, small but meaningful changes stop blending into daily life.</p>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/border-collie-behavior-problems" className="underline hover:opacity-80">Border Collie Behavior Problems: Nipping, Herding, Reactivity, and How to Manage Them</a></li>
          </ul>
        </section>
