  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A practical, research-driven guide to dog daycare safety standards and staff training. Learn the protocols reputable facilities use—from intake and vaccination rules to grouping, ratios, sanitation, and emergency response."
        />
