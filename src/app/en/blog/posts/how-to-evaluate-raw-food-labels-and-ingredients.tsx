      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/dog-food-ingredients-to-avoid" className="underline hover:opacity-80">Dog Food Ingredients to Avoid: An Evidence-Based Checklist</a></li>
            ...
            <li><a href="https://www.petuniapets.com/en/blog/raw-dog-food-safety" className="underline hover:opacity-80">Raw Dog Food Safety: How to Handle &amp; Prepare Raw Diets Without Risk</a></li>
          </ul>
        </section>
