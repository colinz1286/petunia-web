...
export default function ArticlePage() {
  ...
  const title = 'Boxer Skin Problems: Diagnostic Flowchart for Allergies, Infections, and Mast Cell Concerns';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Boxer Skin Problems Diagnostic Flowchart for Allergies, Infections, and Mast Cell Concerns</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/boxer-skin-issues" className="underline hover:opacity-80">Boxer Skin Issues Explained: Allergies, Lumps, and Early Warning Signs</a></li>
            ...
            <li><a href="https://www.petuniapets.com/en/blog/labrador-shampoo-conditioner-guide" className="underline hover:opacity-80">Best Shampoos &amp; Conditioners for Labrador Retrievers: Coat Care, Skin Concerns &amp; Grooming Tips</a></li>
          </ul>
        </section>
