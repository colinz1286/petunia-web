...
export default function ArticlePage() {
  ...
  const title = 'Cavalier Heart Disease Risk: Early Monitoring Plan Every Owner Should Start Before Symptoms';
  const date = 'January 24, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Cavalier Heart Disease Risk Early Monitoring Plan Every Owner Should Start Before Symptoms</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/food-intolerance-allergies-dogs-gi-symptoms" className="underline hover:opacity-80">Food Intolerance vs Food Allergy in Dogs: GI Symptoms, Triggers, and the Elimination Diet Plan</a></li>
