    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/boston-terrier-socialization-guide-2025" className="underline hover:opacity-80">Boston Terrier Socialization Guide (2025): Confidence Building, Safe Exposure, Play Sessions &amp; Adult Socialization</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/are-boston-terriers-good-for-first-time-owners-2025" className="underline hover:opacity-80">Are Boston Terriers Good for First-Time Owners? (2025): Pros, Challenges &amp; Real Expectations</a></li>
