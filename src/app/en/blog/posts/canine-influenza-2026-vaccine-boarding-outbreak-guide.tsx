...
export default function ArticlePage() {
  ...
  const title = 'Canine Influenza in 2026: Vaccine Timing, Boarding Policies, and Outbreak Response for Owners';
  const date = 'February 10, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Canine Influenza in 2026 Vaccine Timing, Boarding Policies, and Outbreak Response for Owners</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/canine-influenza-2025-safety-boosters-boarding-rules" className="underline hover:opacity-80">Canine Influenza 2025: Safety, Boosters &amp; Boarding Rules</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/do-dogs-need-canine-influenza-vaccine" className="underline hover:opacity-80">Do Dogs Need the Canine Influenza Vaccine?</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/fall-seasonal-allergies-in-dogs-usa" className="underline hover:opacity-80">Fall Seasonal Allergies in Dogs (U.S.): Causes, Timing by Region, Signs, Treatments, and a Practical Owner &amp; Boarding Guide</a></li>
          </ul>
        </section>
