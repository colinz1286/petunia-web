...
export default function ArticlePage() {
  ...
  const title = 'Maropitant (Cerenia) in Dogs: Why Symptoms Can Persist and How Vets Troubleshoot Next Steps';
  const date = 'January 18, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Maropitantin Dogs Why Symptoms Can Persist and How Vets Troubleshoot Next Steps</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/allergic-reactions-maropitant-dogs" className="underline hover:opacity-80">Allergic Reactions to Maropitant (Cerenia®) in Dogs: Facial Swelling, Hives, and What to Do</a></li>
            ...
            <li><a href="https://www.petuniapets.com/en/blog/persistent-vomiting-despite-maropitant-dogs" className="underline hover:opacity-80">Why Dogs Can Continue Vomiting Despite Maropitant (Cerenia®)</a></li>
          </ul>
        </section>
