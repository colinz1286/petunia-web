      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/dietary-indiscretion-in-dogs" className="underline hover:opacity-80">Dietary Indiscretion in Dogs: Causes, Symptoms, Risks, and Prevention</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/intestinal-parasites-causing-diarrhea-dogs" className="underline hover:opacity-80">Intestinal Parasites Causing Diarrhea in Dogs: Symptoms, Testing, Treatment, and Prevention</a></li>
