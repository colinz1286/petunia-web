    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/nausea-vomiting-metronidazole-dogs" className="underline hover:opacity-80">What to Do If Your Dog Has Nausea or Vomiting While on Metronidazole</a></li>
