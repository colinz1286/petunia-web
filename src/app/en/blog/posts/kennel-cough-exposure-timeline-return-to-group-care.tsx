...
export default function ArticlePage() {
  ...
  const title = 'Kennel Cough Exposure Timeline: When Dogs Are Contagious and When They Can Return to Group Care';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Kennel Cough Exposure Timeline When Dogs Are Contagious and When They Can Return to Group Care</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/How-to-Handle-a-client-complaint-about-kennel-cough" className="underline hover:opacity-80">How to Handle a Client Complaint About Kennel Cough</a></li>
