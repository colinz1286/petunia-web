...
export default function YorkshireTerrierTrainingGuide() {
    ...
    return (
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/yorkshire-terrier-nutrition-feeding" className="underline hover:opacity-80">Yorkshire Terrier Nutrition &amp; Feeding: What to Feed a Toy Breed with Big Personality</a></li>
