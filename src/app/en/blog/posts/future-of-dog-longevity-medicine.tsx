    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/fda-veterinary-longevity-claims" className="underline hover:opacity-80">How the FDA Evaluates Veterinary Longevity Claims: Conditional Approval, Reasonable Expectation of Effectiveness, Endpoints, and What Owners Should Understand</a></li>
            ...
            <li><a href="https://www.petuniapets.com/en/blog/types-of-golden-retrievers" className="underline hover:opacity-80">Are There Different Types of Golden Retrievers? Types, Similarities &amp; Differences (Owner’s Guide)</a></li>
          </ul>
        </section>
