      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/raw-food-diet-for-puppies-is-it-safe" className="underline hover:opacity-80">Raw Food Diet for Puppies: Is It Safe and What You Should Know</a></li>
