    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/extending-great-dane-lifespan-2025" className="underline hover:opacity-80">Extending the Life of Your Great Dane: Proven Strategies for a Healthier Giant Breed</a></li>
            ...
            <li><a href="https://www.petuniapets.com/en/blog/dog-cognitive-decline-ccd-guide" className="underline hover:opacity-80">Understanding Dog Cognitive Decline: Early Symptoms, Science-Based Interventions, and Quality-of-Life Planning</a></li>
          </ul>
        </section>
