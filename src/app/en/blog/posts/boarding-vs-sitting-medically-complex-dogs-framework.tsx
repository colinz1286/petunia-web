...
export default function ArticlePage() {
  ...
  const title = 'Dog Boarding vs In-Home Sitting for Medically Complex Dogs: Risk Comparison Framework';
  const date = 'February 23, 2026';
  const categories = ["owner","boarding","sitter","vet"] as const;
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Dog Boarding vs In-Home Sitting for Medically Complex Dogs Risk Comparison Framework</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/leptospirosis-vaccine-decision-guide-region-lifestyle" className="underline hover:opacity-80">Leptospirosis Vaccine Decision Guide: Region, Lifestyle, and Boarding Risk in One Framework</a></li>
