      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            ...
            <li><a href="https://www.petuniapets.com/en/blog/pet-owners-underestimate-lifetime-costs-new-study-reveals-hidden-financial-risk" className="underline hover:opacity-80">Pet Owners Underestimate Lifetime Costs: New Study Reveals Hidden Financial Risk</a></li>
            <li><a href="https://www.petuniapets.com/en/blog/raw-food-vs-kibble-vs-fresh-food" className="underline hover:opacity-80">Raw Food vs. Kibble vs. Fresh Food: Which Diet Is Best for Your Dog?</a></li>
          </ul>
        </section>
