...
export default function WolfDNAInModernDogsWhatTheNewStudyFound() {
    ...
    const description =
        'A practical, evidence-based explanation of a major 2025 canine genetics paper: why most dogs carry detectable wolf ancestry, what traits it may affect, and what owners should not assume.';
    ...
    return (
        <>
            <Head>
                ...
                <link
                    rel="canonical"
                    href={`https://www.petuniapets.com/${locale}/blog/wolf-dna-in-modern-dogs-2025-study`}
                />
