            ...
            <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
                ...
                <nav className="mb-8 text-sm">
                    <ul className="flex flex-wrap gap-3">
                        ...
                        <li>
                            <a href="#how-to-read-labels" className="underline hover:opacity-80">
                                How To Read Labels
                            </a>
                        </li>
                        <li>
                            <a href="#toxic-ingredients" className="underline hover:opacity-80">
                                Toxic Ingredients (Never)
                            </a>
                        </li>
                        <li>
                            <a href="#higher-risk-additives" className="underline hover:opacity-80">
                                Higher-Risk Additives
                            </a>
                        </li>
                        <li>
                            <a href="#contaminants" className="underline hover:opacity-80">
                                Contaminants &amp; Manufacturing Risks
                            </a>
                        </li>
                        <li>
                            <a href="#raw-diets" className="underline hover:opacity-80">
                                Raw Diets &amp; Pathogen Risk
                            </a>
                        </li>
                        <li>
                            <a href="#beg-diets" className="underline hover:opacity-80">
                                BEG/Legume-Heavy Diets &amp; DCM
                            </a>
                        </li>
                        <li>
                            <a href="#special-populations" className="underline hover:opacity-80">
                                Puppies, Seniors &amp; Medical
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#checklist" className="underline hover:opacity-80">
                                Shopping Checklist
                            </a>
                        </li>
                        <li>
                ...
                <section id="how-to-read-labels" className="mb-10">
                    <h2 className="text-2xl font-semibold mb-3">
                        How To Read Dog Food Labels (What Matters Most)
                    </h2>
                    <p className="mb-3">
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-3">
                        <li>
                            <strong>Find the AAFCO statement</strong> on the label. It should clearly state the life stage and whether the diet is complete and balanced by formulation or by feeding trials.
                        </li>
                        <li>
                            <strong>Ingredient list</strong> is ordered by weight as fed (with moisture). Fresh meats can appear high but dilute on a dry-matter basis; meat meals are denser. Use this list to spot red flags (e.g., xylitol, onion/garlic powders) and to understand sources of protein, fat, and carbohydrate.
                        </li>
                        <li>
                            <strong>Manufacturer transparency</strong>: companies that publish their nutrition team credentials, conduct digestibility testing, and perform contaminant screening inspire more confidence.
                        </li>
                    </ul>
                ...
                <section id="toxic-ingredients" className="mb-10">
                    <h2 className="text-2xl font-semibold mb-3">
                        Toxic Ingredients (Never in Dog Food or Treats)
                    </h2>
                    <p className="mb-3">
                    ...
                    <h3 className="text-lg font-semibold mb-2">
                        1) Xylitol (also labeled as birch sugar or wood sugar)
                    </h3>
                    <p className="mb-2">
                ...
                <section id="higher-risk-additives" className="mb-10">
                    ...
                    <h3 className="text-lg font-semibold mb-2">
                        1) Artificial Colors (e.g., FD&amp;C dyes; titanium dioxide)
                    </h3>
                    <p className="mb-2">
                    ...
                    <h3 className="text-lg font-semibold mb-2">
                        2) Certain Synthetic Antioxidants (BHA, BHT, Ethoxyquin) vs. Mixed Tocopherols
                    </h3>
                    <p className="mb-2">
                ...
                <section id="contaminants" className="mb-10">
                    <h2 className="text-2xl font-semibold mb-3">
                        Contaminants &amp; Manufacturing Risks (What History Teaches)
                    </h2>
                    <p className="mb-3">
                ...
                <section id="raw-diets" className="mb-10">
                    <h2 className="text-2xl font-semibold mb-3">
                        Raw Diets &amp; Pathogen Risk (Know the Tradeoffs)
                    </h2>
                    <p className="mb-3">
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-3">
                        ...
                        <li>
                            If you pursue raw, select companies that validate pathogen control (e.g., HPP with verification) and publish testing results. Store, thaw, and clean surfaces meticulously.
                        </li>
                    </ul>
                    <div className="rounded-md border border-[#d9cfc2] bg-[#f6efe4] p-4 text-sm">
                ...
                <section id="beg-diets" className="mb-10">
                    <h2 className="text-2xl font-semibold mb-3">
                        BEG/Legume-Heavy Diets &amp; DCM (Where We Are Now)
                    </h2>
                    <p className="mb-3">
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-3">
                        <li>
                            For breeds predisposed to DCM or dogs with cardiac history, consult your veterinarian before using grain-free or legume-heavy diets.
                        </li>
                        <li>
                            Ensure any selected diet meets AAFCO standards for your dog&apos;s life stage and comes from a company with published expertise and quality controls.
                        </li>
                    </ul>
                    <div className="rounded-md border border-[#d9cfc2] bg-[#fffaf1] p-4 text-sm">
                ...
                <section id="special-populations" className="mb-10">
                    <h2 className="text-2xl font-semibold mb-3">
                        Puppies, Seniors, and Medical Considerations
                    </h2>
                    <p className="mb-3">
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-3">
                        <li>
                            Choose products labeled complete and balanced for <strong>growth</strong> or <strong>all life stages</strong>. Large-breed puppies need controlled calcium and energy density to support joint health; confirm the AAFCO life-stage statement and ask the manufacturer for calcium and energy data.
                        </li>
                        <li>
                            Avoid excessive boutique ingredients that displace essential nutrients, and avoid raw diets in households with vulnerable people due to pathogen risks.
                        </li>
                    </ul>
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-3">
                        <li>
                            Senior dogs vary widely. Ask your vet about protein targets, joint support, and calorie adjustments. Prioritize digestibility, stable fats (protected by antioxidants), and clear sourcing.
                        </li>
                    </ul>
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-0">
                        <li>
                            <strong>Food allergies</strong>: Avoid vague, unnamed animal sources; prefer single-protein diets with named ingredients or use hydrolyzed veterinary diets during elimination trials.
                        </li>
                        <li>
                            <strong>GI sensitivities</strong>: Minimize humectants and rich palatants; choose moderate fat and proven digestibility.
                        </li>
                        <li>
                            <strong>Urinary, hepatic, renal</strong>: Work with your veterinarian on prescription formulations and avoid unsupervised supplements or extreme ingredient choices.
                        </li>
                    </ul>
                </section>
                ...
                <section id="myths" className="mb-10">
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-0">
                        ...
                        <li>
                            Unwillingness to answer WSAVA-style questions (Who formulates your diets? What testing do you perform? Do you have a nutritionist on staff?).
                        </li>
                        <li>
                            Unnamed animal ingredients like &ldquo;meat&rdquo; or &ldquo;animal fat&rdquo; without species, especially when paired with minimal quality assurances.
                        </li>
                        <li>
                            Prominent use of marketing terms with little technical detail about safety testing or nutrient validation.
                        </li>
                    </ul>
                </section>
                ...
                <section id="checklist" className="mb-10">
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-3">
                        ...
                        <li>
                            <strong>Named</strong> animal proteins and fats (e.g., chicken, beef liver, salmon oil).
                        </li>
                        <li>
                            Manufacturer provides <strong>team credentials</strong>, <strong>digestibility data</strong>, and <strong>contaminant testing</strong> summaries.
                        </li>
                        <li>
                            Antioxidants listed (mixed tocopherols or clearly dosed permitted preservatives) with a sensible best-by date.
                        </li>
                    </ul>
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-3">
                        ...
                        <li>
                            Generic &ldquo;animal fat&rdquo; or &ldquo;meat digest&rdquo; without species, unless the company provides strong QA documentation and you are not managing an allergy.
                        </li>
                    </ul>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        <li>
                            <strong>Xylitol</strong> (also listed as birch sugar or wood sugar) in any pet product.
                        </li>
                        <li>
                            <strong>Onion or garlic powders</strong> in dog foods, toppers, or treats.
                        </li>
                        <li>Products from companies that cannot provide basic safety and nutrition answers on request.</li>
                        <li>
                            Raw products in homes with infants, elderly, immunocompromised people, or therapy-dog work without verified pathogen control and hygiene plans.
                        </li>
                    </ul>
                </section>
                ...
                <section id="faq" className="mb-16">
                    ...
                    <p className="mb-3">
                        <strong>Is &ldquo;natural&rdquo; always safer?</strong>
                        <br />
                ...
                <section id="sources" className="mb-16">
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700 mb-4">
                        <li>
                            ...
                            <a
                                href="https://www.aafco.org/consumers/understanding-pet-food/reading-pet-food-labels/"
                                target="_blank"
                        ...
                        <li>
                            ...
                            <a
                                href="https://wsava.org/wp-content/uploads/2020/01/Selecting-the-Best-Food-for-your-Pet.pdf"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.fda.gov/animal-veterinary/animal-health-literacy/fdas-regulation-pet-food"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700 mb-4">
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.fda.gov/media/150544/download"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.merckvetmanual.com/toxicology/food-hazards/garlic-and-onion-allium-spp-toxicosis-in-animals"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.merckvetmanual.com/toxicology/food-hazards/grape-raisin-and-tamarind-vitis-spp-tamarindus-spp-toxicosis-in-dogs"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700 mb-4">
                        <li>
                            ...
                            <a
                                href="https://eur-lex.europa.eu/eli/reg_impl/2022/63/oj"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.efsa.europa.eu/en/efsajournal/pub/6585"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.ecfr.gov/current/title-21/part-573"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.aafco.org/consumers/what-is-in-pet-food/"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700 mb-4">
                        <li>
                            ...
                            <a
                                href="https://www.fda.gov/animal-veterinary/outbreaks-and-advisories/recalls-and-safety-alerts"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.fda.gov/inspections-compliance-enforcement-and-criminal-investigations/warning-letters/midwestern-pet-foods-inc-614255-08092021"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.fda.gov/animal-veterinary/cvm-updates/fda-alerts-pet-owners-and-veterinarians-pentobarbital-certain-canned-dog-foods"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.fda.gov/food/food-defense-initiatives/protein-surveillance-assignment-psa-summary-report"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700 mb-4">
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.fda.gov/animal-veterinary/news-events/raw-pet-foods-and-food-safety"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <li>
                            ...
                            <a
                                href="https://www.cdc.gov/salmonella/pet-food-05-21/index.html"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
                        <li>
                            ...
                            <a
                                href="https://www.fda.gov/animal-veterinary/news-events/fda-investigation-potential-link-between-certain-diets-and-canine-dilated-cardiomyopathy"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
