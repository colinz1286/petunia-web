...
export default function ArticlePage() {
  ...
  const title = 'Leptospirosis Vaccine Decision Guide: Region, Lifestyle, and Boarding Risk in One Framework';
  const date = 'February 11, 2026';
    ...
    <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
      ...
      <section id="tldr" className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Leptospirosis Vaccine Decision Guide Region, Lifestyle, and Boarding Risk in One Framework</strong> is easiest to manage when you use a repeatable system, not one-off decisions.</li>
      ...
      <section id="related" className="mb-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/boarding-vs-sitting-medically-complex-dogs-framework" className="underline hover:opacity-80">Dog Boarding vs In-Home Sitting for Medically Complex Dogs: Risk Comparison Framework</a></li>
            ...
            <li><a href="https://www.petuniapets.com/en/blog/canine-influenza-2026-vaccine-boarding-outbreak-guide" className="underline hover:opacity-80">Canine Influenza in 2026: Vaccine Timing, Boarding Policies, and Outbreak Response for Owners</a></li>
          </ul>
        </section>
