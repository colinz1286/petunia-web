    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/supplements-vs-drugs-dog-longevity" className="underline hover:opacity-80">Supplements vs Drugs in Dog Longevity: How Owners Can Tell the Difference, Avoid Marketing Traps, and Make Safer Decisions</a></li>
            ...
            <li><a href="https://www.petuniapets.com/en/blog/dog-boarding-software-costs" className="underline hover:opacity-80">Dog Boarding Software Doesn’t Need to Be Expensive</a></li>
          </ul>
        </section>
