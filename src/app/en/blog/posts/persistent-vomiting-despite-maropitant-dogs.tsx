    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2c4a30]">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-0">
            <li><a href="https://www.petuniapets.com/en/blog/maropitant-cerenia-persistent-symptoms-next-steps" className="underline hover:opacity-80">Maropitant (Cerenia) in Dogs: Why Symptoms Can Persist and How Vets Troubleshoot Next Steps</a></li>
