...
// .local-only/ios-real-reference/BreederClientManagementView.swift.
// Keep client list filtering, relationship actions, and navigation flow aligned across both files.
