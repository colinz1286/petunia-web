...
// .local-only/ios-real-reference/BreederBusinessSettingsView.swift.
// Keep breeder settings fields, validation, and Firestore key usage aligned across both files.
