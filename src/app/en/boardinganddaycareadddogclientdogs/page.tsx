...
// .local-only/ios-real-reference/BoardingAndDaycareAddDogClientDogsSheet.swift.
// Keep dog selection, service-type prompt, and add-to-property behavior aligned across both files.
