...
// NOTE: Mirrors iOS `.local-only/ios-real-reference/IndividualUpcomingAppointmentsView.swift`.
// Keep reservation display and cancellation behavior aligned across platforms.
