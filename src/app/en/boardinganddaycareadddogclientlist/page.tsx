...
// .local-only/ios-real-reference/BoardingAndDaycareAddDogClientListSheet.swift.
// Keep client search, selection, and handoff-to-dog-selection flow aligned across both files.
