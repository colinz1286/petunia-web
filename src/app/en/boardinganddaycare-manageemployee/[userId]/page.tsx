...
// .local-only/ios-real-reference/BoardingAndDaycareManageIndividualEmployeeView.swift.
// Keep role/permission editing and employee removal behavior aligned across both files.
