...
// .local-only/ios-real-reference/BoardingAndDaycareNotificationsView.swift.
// Keep notification loading, unread state handling, and row actions aligned across both files.
