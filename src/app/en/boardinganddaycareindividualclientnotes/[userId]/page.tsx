...
// .local-only/ios-real-reference/BoardingAndDaycareIndividualClientNotesView.swift.
// Keep note loading/saving behavior, character limits, and status messaging aligned across both files.
